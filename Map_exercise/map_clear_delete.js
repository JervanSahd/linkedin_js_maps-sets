...
console.log("Did my key value pair get deleted", saturday.delete(3));
//Delete the element associated with the key 10.
console.log("Did my key value pair get deleted", saturday.delete(10));
//Clear the entire saturday Map object.

saturday.clear();
console.log("How much is left in the map", saturday.size);